...
function CourseDetails() {
    ...
    useEffect(() => {
      if (response?.ratingAndReviews) {
        ...
        let allReviews = response.ratingAndReviews.map((review) => review);
    ...
    useEffect(() => {
      const filteredCourses = response?.instructor?.courses?.filter(
        (course) => {
    ...
    //   console.log("Other Course :- ",filteredCourses);
    ...
    <div className=" z-0">
        ...
        <div className="mx-auto box-content px-4 lg:w-[1260px] 2xl:relative ">
          <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            ...
            <div className="flex w-full flex-col gap-4 border-y border-y-richblack-500 py-4 lg:hidden">
              ...
              <button
                className="yellowButton w-fit mx-auto px-2 text-richblack-900 font-bold py-2 rounded-md bg-yellow-100"
                onClick={
                  user &&
                  response?.studentsEnrolled.includes(
                    user?._id
                  )
              ...
              {(!user ||
                ...
                <button onClick={handleAddToCart} className="blackButton w-fit mx-auto px-4
                text-richblack-5 font-bold py-2 rounded-md bg-caribbeangreen-700">
                  Add to Cart
                </button>
              )}
            </div>
      ...
      <div className="mx-auto box-content px-4 text-start text-richblack-5 lg:w-[1260px]">
        <div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]">
          ...
          <div className="my-8 border border-richblack-600 bg-richblack-900 p-8">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-wrap justify-between gap-2">
                <div className="flex gap-2">
                  ...
                  <span>Duration: {response?.totalDuration}</span>
                </div>
                <div>
                  <button
      ...
      <div className="w-full flex flex-col gap-5 mb-10 text-richblack-5">
        ...
        <div
          id="reviews"
          className="mx-auto mt-20 flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8  text-white"
        >
